...
Section "Geth" GETH_IDX
  ...
  SimpleFC::AdvRemoveRule "Geth incoming peers (TCP:5577)"
  SimpleFC::AdvRemoveRule "Geth outgoing peers (TCP:5577)"
  SimpleFC::AdvRemoveRule "Geth UDP discovery (UDP:5577)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "Geth incoming peers (TCP:5577)" ""  6 1 1 2147483647 1 "$INSTDIR\geth.exe" "" "" "Ethereum" 5577 "" "" ""
  SimpleFC::AdvAddRule "Geth outgoing peers (TCP:5577)" ""  6 2 1 2147483647 1 "$INSTDIR\geth.exe" "" "" "Ethereum" "" 5577 "" ""
  SimpleFC::AdvAddRule "Geth UDP discovery (UDP:5577)" "" 17 2 1 2147483647 1 "$INSTDIR\geth.exe" "" "" "Ethereum" "" 5577 "" ""
